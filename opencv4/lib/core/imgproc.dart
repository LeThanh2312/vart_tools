...
class ImgProc {
  ...
  static Future<dynamic> initOpenCV() async {
    /// Variable to store operation result
    final dynamic result = await _channel.invokeMethod('getOpenCVVersion');
    return result;
  }
  ...
  /// Function takes input file's byte array data, Unit8List
  static Future<dynamic> brightness(Uint8List byteData, int rtype,
      {double alpha = 1, double beta = 0}) async {
    /// Variable to store operation result
