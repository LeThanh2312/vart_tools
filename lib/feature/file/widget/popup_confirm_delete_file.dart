...
class PopUpConfirmDeleteFile extends StatefulWidget {
  const PopUpConfirmDeleteFile({Key? key, required this.file})
      : super(key: key);
  final FileModel file;

  @override
  State<PopUpConfirmDeleteFile> createState() => _PopUpConfirmDeleteFileState();
}

class _PopUpConfirmDeleteFileState extends State<PopUpConfirmDeleteFile> {
  @override
